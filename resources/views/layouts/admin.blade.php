        ...
        <aside class="w-64 bg-wood text-parchment flex-shrink-0 relative">
            ...
            <nav class="mt-6">
                ...
                <a href="{{ route('admin.users.index') }}"
                   class="flex items-center gap-3 px-6 py-3 hover:bg-wood/50 transition-colors {{ request()->routeIs('admin.users.*') ? 'bg-burgundy' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('profile.edit') }}"
                   class="flex items-center gap-3 px-6 py-3 hover:bg-wood/50 transition-colors {{ request()->routeIs('profile.*') ? 'bg-burgundy' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
